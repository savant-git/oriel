...
def main():
    console.print("⚙️  Phase 1: Emergency shell cleanup...")
    shell_phase()
    console.print("⚙️  Phase 2: Intelligent orchestrator cleanup...")
    ...
    console.print("💾 Savant Clean v18 finished successfully.")
...
if __name__ == "__main__":
    try:
        ...
        log(f"❌ Fatal error: {e}")
        rule_status("❌ Cleanup failed. Check logs if space allows.", "error")
