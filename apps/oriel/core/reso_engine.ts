...
export class ResoEngine {
  private static instance: ResoEngine;
  private interval?: NodeJS.Timeout;
  private rate = 1000 / 30; // default 30 Hz

  static getInstance(): ResoEngine {
    if (!ResoEngine.instance) ResoEngine.instance = new ResoEngine();
